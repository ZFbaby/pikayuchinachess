...
void engine_init() {
    ...
    NSString * cacheBundleDir = [[LibraryPaths objectAtIndex:0] stringByAppendingFormat:@"/Caches/Book35/"];
    
    NSString * bundleName = @"entry.nnue";
    NSError * err = nil;
    ...
    CommandLine::init([cacheBundleDir UTF8String]);
    UCI::init(Options);
    Tune::init();
    Bitboards::init();
    Position::init();
